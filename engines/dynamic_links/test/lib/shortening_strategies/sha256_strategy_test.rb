...
module DynamicLinks
  module ShorteningStrategies
    class SHA256StrategyTest < ActiveSupport::TestCase
      def setup
      ...
      test 'shorten returns a string of at least 5 characters' do
        ...
        assert result.length >= DynamicLinks::ShorteningStrategies::SHA256Strategy::MIN_LENGTH
      end
      ...
      test 'shorten handles an empty URL' do
        ...
        assert short_url.length >= DynamicLinks::ShorteningStrategies::SHA256Strategy::MIN_LENGTH
      end
