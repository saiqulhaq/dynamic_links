...
Rails.application.configure do
  ...
  config.logger.info 'DynamicLinksAnalytics engine loaded and ready to process events'
end

# Setup event subscription when the application initializes
Rails.application.config.after_initialize do
  # Verify that the subscription is active
  Rails.logger.info "DynamicLinksAnalytics: Event subscription active for 'link_clicked.dynamic_links'"
