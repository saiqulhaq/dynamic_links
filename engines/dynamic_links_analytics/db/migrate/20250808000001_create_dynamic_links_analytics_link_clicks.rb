class CreateDynamicLinksAnalyticsLinkClicks < ActiveRecord::Migration[7.0]
  def up
    ...
    add_index :dynamic_links_analytics_link_clicks, [:short_url, :clicked_at], name: 'idx_link_clicks_short_url_clicked_at'
    add_index :dynamic_links_analytics_link_clicks, [:client_id, :clicked_at], name: 'idx_link_clicks_client_id_clicked_at'
    add_index :dynamic_links_analytics_link_clicks, [:short_url, :ip_address], name: 'idx_link_clicks_short_url_ip'
    ...
    add_index :dynamic_links_analytics_link_clicks, "(metadata ->> 'utm_campaign')", name: 'idx_link_clicks_utm_campaign'
